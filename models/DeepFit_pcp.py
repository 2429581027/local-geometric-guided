...
class DeepFit(nn.Module):
    def __init__(self, k=1, num_points=500, use_point_stn=False,  use_feat_stn=False, point_tuple=1,
        ...
        self.transformer = transformer.Transformer(emb_dims=feature_dim, n_blocks=1, dropout=0, ff_dims=2*feature_dim, n_heads=4)
    ...
    def forward(self, pts_feas):
        ...
        final_normal = self.fc2(x) 

        return final_normal, normal, beta.squeeze(), weights.squeeze(), trans, trans2, neighbor_normals
