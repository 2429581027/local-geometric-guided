...
def parse_arguments():
    ...
    parser.add_argument('--models', type=str, default='TrueWeight+jet_order_1+neighbor_96_residuedis_sigma_max_0.1mean_0.0025_selected_20_20_normalguid_6_pca_STN_yes_yes_consistency_loss_no', help='names of trained models, can evaluate multiple models')
        ...
        for batchind, data in batch_enum:
            ...
            with torch.no_grad():
                if trainopt.arch == 'simple' or trainopt.arch == 'res' or trainopt.arch == '3dmfv':
                    ...
                    n_est, beta_pred, weights, trans, trans2, neighbor_normals = regressor(pts_feas)
                    end_time = time.time()
